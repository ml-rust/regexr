...
//
//   ucd-generate property-names /home/farhan/Projects/tokenizer/regexr/data/.ucd-temp/ucd-17.0.0
//
...
pub const PROPERTY_NAMES: &'static [(&'static str, &'static str)] = &[
  ...
  ("cjkirgmsource", "kIRG_MSource"), ("cjkirgssource", "kIRG_SSource"),
  ("cjkirgtsource", "kIRG_TSource"), ("cjkirguksource", "kIRG_UKSource"),
  ("cjkirgusource", "kIRG_USource"), ("cjkirgvsource", "kIRG_VSource"),
  ("cjkmandarin", "kMandarin"), ("cjkothernumeric", "kOtherNumeric"),
  ...
  ("eastasianwidth", "East_Asian_Width"), ("ebase", "Emoji_Modifier_Base"),
  ("ecomp", "Emoji_Component"), ("emod", "Emoji_Modifier"),
  ("emoji", "Emoji"), ("emojicomponent", "Emoji_Component"),
  ...
  ("extender", "Extender"), ("extpict", "Extended_Pictographic"),
  ...
  ("idc", "ID_Continue"), ("idcompatmathcontinue", "ID_Compat_Math_Continue"),
  ("idcompatmathstart", "ID_Compat_Math_Start"),
  ("idcontinue", "ID_Continue"), ("ideo", "Ideographic"),
  ("ideographic", "Ideographic"), ("ids", "ID_Start"),
  ("idsb", "IDS_Binary_Operator"),
  ("idsbinaryoperator", "IDS_Binary_Operator"),
  ("idst", "IDS_Trinary_Operator"), ("idstart", "ID_Start"),
  ("idstrinaryoperator", "IDS_Trinary_Operator"),
  ("idsu", "IDS_Unary_Operator"), ("idsunaryoperator", "IDS_Unary_Operator"),
  ...
  ("kcompatibilityvariant", "kCompatibilityVariant"), ("kehcat", "kEH_Cat"),
  ("kehdesc", "kEH_Desc"), ("kehhg", "kEH_HG"), ("kehifao", "kEH_IFAO"),
  ("kehjsesh", "kEH_JSesh"), ("kehnomirror", "kEH_NoMirror"),
  ("kehnorotate", "kEH_NoRotate"), ("kiicore", "kIICore"),
  ...
  ("kirgssource", "kIRG_SSource"), ("kirgtsource", "kIRG_TSource"),
  ("kirguksource", "kIRG_UKSource"), ("kirgusource", "kIRG_USource"),
  ("kirgvsource", "kIRG_VSource"), ("kmandarin", "kMandarin"),
  ("kothernumeric", "kOtherNumeric"), ("kprimarynumeric", "kPrimaryNumeric"),
  ("krsunicode", "kRSUnicode"), ("ktotalstrokes", "kTotalStrokes"),
  ("kunihancore2020", "kUnihanCore2020"), ("lb", "Line_Break"),
  ("lc", "Lowercase_Mapping"), ("linebreak", "Line_Break"),
  ("loe", "Logical_Order_Exception"),
  ("logicalorderexception", "Logical_Order_Exception"),
  ("lower", "Lowercase"), ("lowercase", "Lowercase"),
  ("lowercasemapping", "Lowercase_Mapping"), ("math", "Math"),
  ("mcm", "Modifier_Combining_Mark"),
  ("modifiercombiningmark", "Modifier_Combining_Mark"), ("na", "Name"),
  ...
  ("nfkcquickcheck", "NFKC_Quick_Check"), ("nfkcscf", "NFKC_Simple_Casefold"),
  ("nfkcsimplecasefold", "NFKC_Simple_Casefold"),
  ("nfkdqc", "NFKD_Quick_Check"), ("nfkdquickcheck", "NFKD_Quick_Check"),
