...
//
//   ucd-generate script-extension /home/farhan/Projects/tokenizer/regexr/data/.ucd-temp/ucd-17.0.0
//
...
pub const ADLAM: &'static [(u32, u32)] = &[
  (1567, 1567), (1600, 1600), (8271, 8271), (11841, 11841), (125184, 125259),
  (125264, 125273), (125278, 125279),
];
...
pub const ARABIC: &'static [(u32, u32)] = &[
  (1536, 1540), (1542, 1756), (1758, 1791), (1872, 1919), (2160, 2193),
  (2199, 2273), (2275, 2303), (8271, 8271), (11841, 11841), (64336, 64975),
  (65008, 65023), (65136, 65140), (65142, 65276), (66272, 66299),
  (69216, 69246), (69314, 69319), (69328, 69336), (69370, 69375),
...
pub const AVESTAN: &'static [(u32, u32)] = &[
  (183, 183), (11824, 11825), (68352, 68405), (68409, 68415),
];
...
pub const BENGALI: &'static [(u32, u32)] = &[
  (700, 700), (2385, 2386), (2404, 2405), (2432, 2435), (2437, 2444),
  (2447, 2448), (2451, 2472), (2474, 2480), (2482, 2482), (2486, 2489),
  (2492, 2500), (2503, 2504), (2507, 2510), (2519, 2519), (2524, 2525),
  (2527, 2531), (2534, 2558), (7376, 7376), (7378, 7378), (7381, 7382),
  (7384, 7384), (7393, 7393), (7402, 7402), (7405, 7405), (7410, 7410),
  (7413, 7415), (43249, 43249),
];

pub const BERIA_ERFE: &'static [(u32, u32)] = &[
  (93856, 93880), (93883, 93907),
];
...
pub const BOPOMOFO: &'static [(u32, u32)] = &[
  (711, 711), (713, 715), (729, 729), (746, 747), (12289, 12291),
  (12296, 12305), (12307, 12319), (12330, 12333), (12336, 12336),
  (12343, 12343), (12539, 12539), (12549, 12591), (12704, 12735),
  (65093, 65094), (65377, 65381),
];
...
pub const CHEROKEE: &'static [(u32, u32)] = &[
  (768, 770), (772, 772), (779, 780), (803, 804), (816, 817), (5024, 5109),
  (5112, 5117), (43888, 43967),
];
...
pub const COMMON: &'static [(u32, u32)] = &[
  (0, 64), (91, 96), (123, 169), (171, 182), (184, 185), (187, 191),
  (215, 215), (247, 247), (697, 699), (701, 710), (712, 712), (716, 716),
  (718, 726), (728, 728), (730, 735), (741, 745), (748, 767), (894, 894),
  (901, 901), (903, 903), (1541, 1541), (1757, 1757), (2274, 2274),
  (3647, 3647), (4053, 4056), (8192, 8203), (8206, 8238), (8240, 8270),
  (8272, 8281), (8283, 8284), (8286, 8292), (8294, 8304), (8308, 8318),
  (8320, 8334), (8352, 8385), (8448, 8485), (8487, 8489), (8492, 8497),
  (8499, 8525), (8527, 8543), (8585, 8587), (8592, 9257), (9280, 9290),
  (9312, 10239), (10496, 11123), (11126, 11263), (11776, 11798),
  (11800, 11823), (11826, 11835), (11837, 11840), (11842, 11842),
  (11844, 11869), (12288, 12288), (12292, 12292), (12306, 12306),
  ...
  (117760, 118012), (118016, 118451), (118458, 118480), (118496, 118512),
  (118608, 118723), (118784, 119029), (119040, 119078), (119081, 119142),
  (119146, 119162), (119171, 119172), (119180, 119209), (119214, 119274),
  (119488, 119507), (119520, 119539), (119552, 119638), (119666, 119672),
  ...
  (120782, 120831), (126065, 126132), (126209, 126269), (126976, 127019),
  (127024, 127123), (127136, 127150), (127153, 127167), (127169, 127183),
  (127185, 127221), (127232, 127405), (127462, 127487), (127489, 127490),
  (127504, 127547), (127552, 127560), (127584, 127589), (127744, 128728),
  (128732, 128748), (128752, 128764), (128768, 128985), (128992, 129003),
  (129008, 129008), (129024, 129035), (129040, 129095), (129104, 129113),
  (129120, 129159), (129168, 129197), (129200, 129211), (129216, 129217),
  (129232, 129240), (129280, 129623), (129632, 129645), (129648, 129660),
  (129664, 129674), (129678, 129734), (129736, 129736), (129741, 129756),
  (129759, 129770), (129775, 129784), (129792, 129938), (129940, 130042),
  (917505, 917505), (917536, 917631),
];

pub const COPTIC: &'static [(u32, u32)] = &[
  (183, 183), (768, 768), (772, 773), (775, 775), (884, 885), (994, 1007),
  (11392, 11507), (11513, 11519), (11799, 11799), (66272, 66299),
];
...
pub const CYRILLIC: &'static [(u32, u32)] = &[
  (700, 700), (768, 770), (772, 772), (774, 774), (776, 776), (779, 779),
  (785, 785), (1024, 1327), (7296, 7306), (7467, 7467), (7544, 7544),
  (7672, 7672), (11744, 11775), (11843, 11843), (42560, 42655),
  (65070, 65071), (122928, 122989), (123023, 123023),
];
...
pub const DEVANAGARI: &'static [(u32, u32)] = &[
  (700, 700), (2304, 2386), (2389, 2431), (7376, 7414), (7416, 7417),
  (8432, 8432), (43056, 43065), (43232, 43263), (72448, 72457),
];
...
pub const ETHIOPIC: &'static [(u32, u32)] = &[
  (782, 782), (4608, 4680), (4682, 4685), (4688, 4694), (4696, 4696),
  (4698, 4701), (4704, 4744), (4746, 4749), (4752, 4784), (4786, 4789),
  (4792, 4798), (4800, 4800), (4802, 4805), (4808, 4822), (4824, 4880),
  (4882, 4885), (4888, 4954), (4957, 4988), (4992, 5017), (11648, 11670),
  ...
  (43816, 43822), (124896, 124902), (124904, 124907), (124909, 124910),
  (124912, 124926),
];

pub const GARAY: &'static [(u32, u32)] = &[
  (1548, 1548), (1563, 1563), (1567, 1567), (68928, 68965), (68969, 68997),
  (69006, 69007),
];

pub const GEORGIAN: &'static [(u32, u32)] = &[
  (183, 183), (1417, 1417), (4256, 4293), (4295, 4295), (4301, 4301),
  (4304, 4351), (7312, 7354), (7357, 7359), (8282, 8282), (11520, 11557),
  (11559, 11559), (11565, 11565), (11825, 11825),
];

pub const GLAGOLITIC: &'static [(u32, u32)] = &[
  (183, 183), (771, 771), (773, 773), (1156, 1156), (1159, 1159),
  (1417, 1417), (4347, 4347), (8282, 8282), (11264, 11359), (11843, 11843),
  (42607, 42607), (122880, 122886), (122888, 122904), (122907, 122913),
  (122915, 122916), (122918, 122922),
];

pub const GOTHIC: &'static [(u32, u32)] = &[
  (183, 183), (772, 773), (776, 776), (817, 817), (66352, 66378),
];
...
pub const GREEK: &'static [(u32, u32)] = &[
  (183, 183), (768, 769), (772, 772), (774, 774), (776, 776), (787, 787),
  (834, 834), (837, 837), (880, 887), (890, 893), (895, 895), (900, 900),
  (902, 902), (904, 906), (908, 908), (910, 929), (931, 993), (1008, 1023),
  (7462, 7466), (7517, 7521), (7526, 7530), (7615, 7617), (7936, 7957),
  ...
  (8285, 8285), (8486, 8486), (43877, 43877), (65856, 65934), (65952, 65952),
  (119296, 119365),
];
...
pub const GUNJALA_GONDI: &'static [(u32, u32)] = &[
  (183, 183), (2404, 2405), (73056, 73061), (73063, 73064), (73066, 73102),
...
pub const GURUNG_KHEMA: &'static [(u32, u32)] = &[
  (2405, 2405), (90368, 90425),
];

pub const HAN: &'static [(u32, u32)] = &[
  (183, 183), (11904, 11929), (11931, 12019), (12032, 12245), (12272, 12287),
  (12289, 12291), (12293, 12305), (12307, 12319), (12321, 12333),
  (12336, 12336), (12343, 12351), (12539, 12539), (12688, 12703),
  (12736, 12773), (12783, 12783), (12832, 12871), (12928, 12976),
  (12992, 13003), (13055, 13055), (13144, 13168), (13179, 13183),
  (13280, 13310), (13312, 19903), (19968, 40959), (42752, 42759),
  (63744, 64109), (64112, 64217), (65093, 65094), (65377, 65381),
  (94178, 94179), (94192, 94198), (119648, 119665), (127568, 127569),
...
pub const HEBREW: &'static [(u32, u32)] = &[
  (775, 776), (1425, 1479), (1488, 1514), (1519, 1524), (64285, 64310),
...
pub const HIRAGANA: &'static [(u32, u32)] = &[
  ...
  (65438, 65439), (110593, 110879), (110898, 110898), (110928, 110930),
  (127488, 127488),
];
...
pub const INHERITED: &'static [(u32, u32)] = &[
  (783, 783), (786, 786), (788, 802), (806, 812), (815, 815), (818, 833),
  (835, 836), (838, 855), (857, 861), (863, 866), (2387, 2388), (6832, 6877),
  (6880, 6891), (7618, 7671), (7673, 7673), (7675, 7679), (8204, 8205),
  (8400, 8431), (65024, 65039), (65056, 65069), (66045, 66045),
  (118528, 118573), (118576, 118598), (119143, 119145), (119163, 119170),
...
pub const KAITHI: &'static [(u32, u32)] = &[
  (2406, 2415), (11825, 11825), (43056, 43065), (69760, 69826),
  (69837, 69837),
];
...
pub const KANNADA: &'static [(u32, u32)] = &[
  ...
  (3285, 3286), (3292, 3294), (3296, 3299), (3302, 3311), (3313, 3315),
  (7376, 7376), (7378, 7379), (7386, 7386), (7410, 7410), (7412, 7412),
  (43056, 43061),
];

pub const KATAKANA: &'static [(u32, u32)] = &[
  (773, 773), (803, 803), (12289, 12291), (12296, 12305), (12307, 12319),
  (12336, 12341), (12343, 12343), (12348, 12349), (12441, 12444),
  (12448, 12543), (12784, 12799), (13008, 13054), (13056, 13143),
  (65093, 65094), (65377, 65439), (110576, 110579), (110581, 110587),
  (110589, 110590), (110592, 110592), (110880, 110882), (110933, 110933),
  (110948, 110951),
];

pub const KAWI: &'static [(u32, u32)] = &[
...
pub const KHOJKI: &'static [(u32, u32)] = &[
  (2790, 2799), (43056, 43065), (70144, 70161), (70163, 70209),
];
...
pub const KIRAT_RAI: &'static [(u32, u32)] = &[
  (93504, 93561),
];

pub const LAO: &'static [(u32, u32)] = &[
  (3713, 3714), (3716, 3716), (3718, 3722), (3724, 3747), (3749, 3749),
  (3751, 3773), (3776, 3780), (3782, 3782), (3784, 3790), (3792, 3801),
  (3804, 3807),
];

pub const LATIN: &'static [(u32, u32)] = &[
  (65, 90), (97, 122), (170, 170), (183, 183), (186, 186), (192, 214),
  (216, 246), (248, 696), (700, 700), (711, 711), (713, 715), (717, 717),
  (727, 727), (729, 729), (736, 740), (768, 782), (784, 785), (787, 787),
  (803, 805), (813, 814), (816, 817), (856, 856), (862, 862), (867, 879),
  (1157, 1158), (2385, 2386), (4347, 4347), (7424, 7461), (7468, 7516),
  (7522, 7525), (7531, 7543), (7545, 7614), (7672, 7672), (7680, 7935),
  (8239, 8239), (8305, 8305), (8319, 8319), (8336, 8348), (8432, 8432),
  (8490, 8491), (8498, 8498), (8526, 8526), (8544, 8584), (11360, 11391),
  (11799, 11799), (42752, 42759), (42786, 42887), (42891, 42972),
  (42993, 43007), (43310, 43310), (43824, 43866), (43868, 43876),
...
pub const LYCIAN: &'static [(u32, u32)] = &[
  (8282, 8282), (66176, 66204),
];

pub const LYDIAN: &'static [(u32, u32)] = &[
  (183, 183), (11825, 11825), (67872, 67897), (67903, 67903),
];

pub const MAHAJANI: &'static [(u32, u32)] = &[
  (183, 183), (2404, 2415), (43056, 43065), (69968, 70006),
];
...
pub const MONGOLIAN: &'static [(u32, u32)] = &[
  (6144, 6169), (6176, 6264), (6272, 6314), (8239, 8239), (12289, 12290),
  (12296, 12299), (71264, 71276),
];
...
pub const NAG_MUNDARI: &'static [(u32, u32)] = &[
  (124112, 124153),
];

pub const NANDINAGARI: &'static [(u32, u32)] = &[
  (2385, 2385), (2404, 2405), (3302, 3311), (7401, 7401), (7410, 7410),
  (7418, 7418), (43056, 43061), (72096, 72103), (72106, 72151),
  (72154, 72164),
];
...
pub const NEWA: &'static [(u32, u32)] = &[
  (2385, 2386), (7381, 7381), (7383, 7384), (7394, 7394), (7401, 7401),
  (7403, 7403), (7405, 7405), (70656, 70747), (70749, 70753),
];
...
pub const OL_ONAL: &'static [(u32, u32)] = &[
  (2404, 2405), (124368, 124410), (124415, 124415),
];

pub const OLD_HUNGARIAN: &'static [(u32, u32)] = &[
  (8282, 8282), (8285, 8285), (11825, 11825), (11841, 11841), (68736, 68786),
  (68800, 68850), (68858, 68863),
];
...
pub const OLD_PERMIC: &'static [(u32, u32)] = &[
  (183, 183), (768, 768), (774, 776), (787, 787), (1155, 1155),
  (66384, 66426),
];
...
pub const OLD_TURKIC: &'static [(u32, u32)] = &[
  (8282, 8282), (11824, 11824), (68608, 68680),
];
...
pub const OSAGE: &'static [(u32, u32)] = &[
  (769, 769), (772, 772), (779, 779), (856, 856), (66736, 66771),
  (66776, 66811),
];
...
pub const SAMARITAN: &'static [(u32, u32)] = &[
  (2048, 2093), (2096, 2110), (11825, 11825),
];
...
pub const SHARADA: &'static [(u32, u32)] = &[
  ...
  (7402, 7402), (7405, 7405), (43056, 43061), (43064, 43064), (70016, 70111),
  (72544, 72551),
];
...
pub const SIDETIC: &'static [(u32, u32)] = &[
  (67904, 67929),
];
...
pub const SINHALA: &'static [(u32, u32)] = &[
  ...
  (3544, 3551), (3558, 3567), (3570, 3572), (7410, 7410), (70113, 70132),
];
...
pub const SUNUWAR: &'static [(u32, u32)] = &[
  (768, 769), (771, 771), (781, 781), (784, 784), (813, 813), (817, 817),
  (72640, 72673), (72688, 72697),
];
...
pub const SYRIAC: &'static [(u32, u32)] = &[
  (771, 772), (775, 776), (778, 778), (803, 805), (813, 814), (816, 817),
...
pub const TAI_LE: &'static [(u32, u32)] = &[
  (768, 769), (775, 776), (780, 780), (4160, 4169), (6480, 6509),
  (6512, 6516),
];
...
pub const TAI_YO: &'static [(u32, u32)] = &[
...
pub const TANGUT: &'static [(u32, u32)] = &[
  (12272, 12287), (12783, 12783), (94176, 94176), (94208, 101119),
  (101632, 101662), (101760, 101874),
];
...
pub const TELUGU: &'static [(u32, u32)] = &[
  ...
  (3160, 3162), (3164, 3165), (3168, 3171), (3174, 3183), (3191, 3199),
  (7381, 7382), (7384, 7384), (7386, 7386), (7410, 7410),
];
...
pub const TIBETAN: &'static [(u32, u32)] = &[
  ...
  (4046, 4052), (4057, 4058), (12296, 12299),
];

pub const TIFINAGH: &'static [(u32, u32)] = &[
  (770, 770), (772, 772), (774, 777), (803, 803), (11568, 11623),
  (11631, 11632), (11647, 11647),
];

pub const TIRHUTA: &'static [(u32, u32)] = &[
  (2385, 2386), (2404, 2405), (7381, 7381), (7394, 7394), (7410, 7410),
  (43056, 43065), (70784, 70855), (70864, 70873),
];

pub const TODHRI: &'static [(u32, u32)] = &[
  (769, 769), (772, 772), (775, 775), (785, 785), (787, 787), (862, 862),
  (67008, 67059),
];

pub const TOLONG_SIKI: &'static [(u32, u32)] = &[
  (73136, 73179), (73184, 73193),
];

pub const TOTO: &'static [(u32, u32)] = &[
  (700, 700), (123536, 123566),
];

pub const TULU_TIGALARI: &'static [(u32, u32)] = &[
  (3302, 3311), (7410, 7410), (7412, 7412), (43056, 43061), (43249, 43249),
  (70528, 70537), (70539, 70539), (70542, 70542), (70544, 70581),
  (70583, 70592), (70594, 70594), (70597, 70597), (70599, 70602),
  (70604, 70613), (70615, 70616), (70625, 70626),
];
